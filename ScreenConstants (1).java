...
public class ScreenConstants {	
	...
	public static final String HISTORY = "ScreeningHistory";
	...
	/*******************************Folio************************************/	
	public static final String FOLIOALLIGATIONS = "FolioAllegations";
	public static final String FOLIODISPOSITION = "FolioDisposition";
	public static final String FOLIOCOMMERCIALSEXUALEXPLOITATION = "FolioCommercialSexualExploite";
	...
	public static final String FOLIODETAILS = "FolioDetails";
	public static final String FOLIOASSIGNMENTS = "Assignments";
	public static final String FOLIOCORRESPONDENCE = "FolioCorrespondence";
	public static final String FOLIOHISTORY = "FolioHistory";
	public static final String FOLIOSCREENINGREVIEW = "FolioScreeningReview";
	public static final String FOLIOTRIBALINQUIRYANDCOLLABORATION = "FolioTribalInquiry";
	public static final String FOLIOCONTACTLOG = "FolioContactLog";
	public static final String FOLIODOCUMENTS = "FolioDOcuments";
	public static final String FOLIOAPPROVALANDAUDITHISTORY = "FolioApprovalAndAuditHistory";
	public static final String RELATEDFOLIOS = "RelatedFolios";
	public static final String SCREENINGSINFOLIO = "ScreeningsInFolio";
	public static final String FOLIOATTORNEYCLIENTLOG = "FolioAttorneyClientLog";
	public static final String FOLIOSUBMITFORAPPROVAL = "FolioSubmitForApproval";
	public static final String FOLIOCHANGEASSIGNMENTS = "FolioChangeAssignments";
	public static final String FOLIOPERSONS = "FolioPerson";
	public static final String FOLIOVALIDATEPERSON ="FolioValidatePerson";
	public static final String FOLIOADDENDUMS ="FolioAddendums";
	public static final String FOLIONEWCASE ="FolioNewCase";
	public static final String FOLIOPLACEMENT ="FolioPlacement";
	public static final String FOLIOCHILDLOCATIONS ="FolioChildLocations";
	public static final String FOLIOCHILDLOCATIONABSENCES ="FolioChildLocationAbsences";
	...
	public static final String FOLIOSERVICECOMPONENTS ="FolioServiceComponents";
	public static final String FOLIORELEASESOFINFORMATIONANDCONSENTFORM ="FolioReleasesOfInformation";
	public static final String FOLIOVISITLOGS ="FolioVisitLogs";
	public static final String FOLIOCASECLOSURE ="FolioCaseClosure";
	public static final String FOLIOCHILDLOCATIONCONTACTLOGS ="FolioChildLocationContactLogs";
	public static final String FOLIOPLACEMENTNEEDS ="FolioPlacementNeeds";
	public static final String FOLIOTRIBEPLACEMENTPREFERENCES ="FolioTribePlacementPreferences";
	...
	public static final String FOLIOERR = "FolioERR";
	public static final String FOLIOFAMILYTRANSFERTYPE = "FolioFamilyTransfer";
	public static final String FOLIOCASETYPE = "FolioCaseType";
	public static final String FOLIOCASESTOTRANSFER ="FolioCasesToTransfer";
	public static final String FOLIOFAMILYTRANSFERRECORD = "FolioFamilyTransferRecord";
	...
	public static final String CASESTOTRANSFER = "CasestoTransfers";
	
	public static final String FOLIOTASK = "FolioTask";
	...
	public static final String FOLIOCHILDLOCATIONRATES ="FolioChildLocationRates";
	
	public static final String RELEASESOFINFORMATIONANDCONSENTFORM = "ReleasesOfInformationAndConsentForm";
	public static final String REMOVAL ="Removal";
	public static final String FOLIOCHILDLOCATIONAUDITHISTORY ="FolioChildLocationAuditHistory";
	public static final String FOLIOBACKGROUNDCHECKS = "FolioBackgroundChecks";
	public static final String  FOLIOCHILDLOCATIONOVERSTAYREPORTS="FolioChildLocationOverstayReports";
	public static final String LEGALAUTHORITY ="Legal Authority";
	
	public static final String SPECIALIZATION ="Specialization";
	
	public static final String FOLIOINSPECTIONS = "FolioInspections";
	public static final String FOLIOPROMOTETOCASE = "FolioPromoteToCase";
	...
	public static final String CASERELATEDFOLIOS = "CaseRelatedFolios";
	public static final String CASEFOLIOPERSONS = "CaseFolioPersons";
	...
	public static final String COURTMINUTEORDER = "CourtMinuteOrder";
	public static final String DOCUMENTDISTRIBUTIONS = "DocumentDistributions";
	public static final String RELATEDFOLIO = "RelatedFolios";
	public static final String COURTWORKITEMS = "CourtWorkItems";
	
	/*********************** Organization ***********************************/
	public static final String ORGANIZATIONSPROVIDERSEARCH = "OrganizationProviderSearch";
